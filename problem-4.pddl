(define (problem shopbot_supermarket4)
    (:domain shopbot_supermarket4)
    ...
    (:objects
        ...
        (:init
            ...
            ;; Position of robot
            (at_shopbot bot1 cell20)
            (at_shopbot bot2 cell19)
            ...
            ;; Position of top up top_up_station
            (adjacent cell8 top_up)

            ;; Original balanca of bot
            (= (balance bot1) 15)
            (= (balance bot2) 11)

            (holding_nothing bot1)
            (holding_nothing bot2)
        )

        (:goal
            (and
                (checked_out_by bot1 potato)
                (checked_out_by bot1 ketchup)
                (checked_out_by bot1 toothpaste)
                (checked_out_by bot1 pizza)

                (checked_out_by bot2 cabbage)
                (checked_out_by bot2 bread)
                (checked_out_by bot2 shampoo)
                (checked_out_by bot2 ice_lolly)
            )
