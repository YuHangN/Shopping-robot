(define (problem shopbot_supermarket5)
    (:domain shopbot_supermarket5)
    ...
    (:objects
        ...
        (:init
            ...
            (= (balance) 20)
            (= (basket_capacity) 10)
            (= (item_in_basket pizza) 0)
            (= (item_in_basket cabbage) 0)
            (= (item_in_basket potato) 0)
            (= (item_in_basket ice_lolly) 0)
            (= (item_in_basket shampoo) 0)
            (= (item_in_basket bread) 0)
            (= (item_in_basket ketchup) 0)

            (= (item_needed pizza) 5)
            (= (item_needed cabbage) 3)
        )

        (:goal
            (and
                (= (item_needed cabbage) 0)
                (= (item_needed pizza) 0)
            )
        )
)